...
public:
	 ...
	 float getRatioXDroppable( Json::Value root_droppables, float droppable_ancho );
	 float getRatioYDroppable( Json::Value root_droppables, float droppable_alto );
	 ...
	 vector<ObjetoDroppable*> cargarDroppables(string ruta_carpeta, string ruta_sonidos, Ventana* ventana);
	 ...
	 void cargarTextosPelea(Mundo* mundo);
};
