...
Escenario* generarEscenarioDefault(Ventana* ventana) {
	...
	CapaPrincipal* capa_principal = new CapaPrincipal(ESCENARIO_ALTO_DEFAULT, ESCENARIO_ANCHO_DEFAULT, PERSONAJES_Z_INDEX_DEFAULT, ESCENARIO_ANCHO_DEFAULT, VENTANA_ANCHO_DEFAULT,Y_PISO_DEFAULT);
